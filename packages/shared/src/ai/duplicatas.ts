...
export function saoAMesma(a: FaixaComparavel, b: FaixaComparavel): string | null {
  ...
  if (!mesmoArtista(a, b)) return null;
  ...
  // Caminho 1: título igual depois de limpo + duração compatível. É o caso
  // clássico do mesmo clipe subido por dois canais.
  if (semTitulo >= MIN_TITULO && duracaoBate) {
